...
#endif
            VL_FATAL_MT("sorter_id.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vsorter_id___024root____Vm_traceActivitySetAll(Vsorter_id___024root* vlSelf);
...
VL_ATTR_COLD void Vsorter_id___024root___eval_stl(Vsorter_id___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vsorter_id___024root____Vm_traceActivitySetAll(vlSelf);
    }
}
...
VL_ATTR_COLD void Vsorter_id___024root____Vm_traceActivitySetAll(Vsorter_id___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vsorter_id___024root____Vm_traceActivitySetAll\n"); );
    Vsorter_id__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vsorter_id___024root___ctor_var_reset(Vsorter_id___024root* vlSelf) {
    ...
    vlSelf->sorter_id__DOT____Vcellout__c0__max_id = VL_RAND_RESET_I(2);
    vlSelf->sorter_id__DOT____Vcellout__c0__min_id = VL_RAND_RESET_I(2);
    vlSelf->sorter_id__DOT____Vcellout__c1__max_id = VL_RAND_RESET_I(2);
    vlSelf->sorter_id__DOT____Vcellout__c1__min_id = VL_RAND_RESET_I(2);
    vlSelf->sorter_id__DOT____Vcellout__c2__min_id = VL_RAND_RESET_I(2);
    vlSelf->sorter_id__DOT____Vcellout__c3__max_id = VL_RAND_RESET_I(2);
    vlSelf->sorter_id__DOT____Vcellout__c3__min_id = VL_RAND_RESET_I(2);
    vlSelf->sorter_id__DOT____Vcellout__c4__min_id = VL_RAND_RESET_I(2);
