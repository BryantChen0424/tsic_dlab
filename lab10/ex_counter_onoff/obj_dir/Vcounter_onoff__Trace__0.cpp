...
void Vcounter_onoff___024root__trace_chg_0_sub_0(Vcounter_onoff___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+4,(vlSelfRef.counter_onoff__DOT__S));
    bufp->chgBit(oldp+5,(vlSelfRef.counter_onoff__DOT__S_nxt));
    bufp->chgCData(oldp+6,(vlSelfRef.counter_onoff__DOT__cnt_nxt),6);
}
