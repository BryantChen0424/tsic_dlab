...
VL_INLINE_OPT void Vmod___024root___ico_sequent__TOP__0(Vmod___024root* vlSelf) {
    ...
    if ((0U == (IData)(vlSelfRef.mod__DOT__S))) {
        if (vlSelfRef.valid) {
            ...
            vlSelfRef.mod__DOT__a_nxt = vlSelfRef.dividend;
        }
    } else {
        if ((1U != (IData)(vlSelfRef.mod__DOT__S))) {
        ...
        if ((1U == (IData)(vlSelfRef.mod__DOT__S))) {
            ...
            if (((IData)(vlSelfRef.mod__DOT__a) >= (IData)(vlSelfRef.mod__DOT__b))) {
                vlSelfRef.mod__DOT__a_nxt = (0xffU 
                                             & ((IData)(vlSelfRef.mod__DOT__a) 
                                                - (IData)(vlSelfRef.mod__DOT__b)));
            }
        } else {
            vlSelfRef.mod__DOT__S_nxt = 0U;
            if ((2U != (IData)(vlSelfRef.mod__DOT__S))) {
                vlSelfRef.mod__DOT__a_nxt = 0U;
            }
        }
    }
}
...
#endif
            VL_FATAL_MT("mod.v", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("mod.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("mod.v", 1, "", "Active region did not converge.");
            }
