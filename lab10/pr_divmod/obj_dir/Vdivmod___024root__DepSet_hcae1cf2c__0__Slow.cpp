...
#endif
            VL_FATAL_MT("divmod.v", 1, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vdivmod___024root____Vm_traceActivitySetAll(Vdivmod___024root* vlSelf);
...
VL_ATTR_COLD void Vdivmod___024root___eval_stl(Vdivmod___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        ...
        Vdivmod___024root____Vm_traceActivitySetAll(vlSelf);
    }
}
...
VL_ATTR_COLD void Vdivmod___024root____Vm_traceActivitySetAll(Vdivmod___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdivmod___024root____Vm_traceActivitySetAll\n"); );
    Vdivmod__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
