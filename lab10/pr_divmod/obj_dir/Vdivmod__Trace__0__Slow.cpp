...
VL_ATTR_COLD void Vdivmod___024root__trace_init_sub__TOP__0(Vdivmod___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+8,0,"valid",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+12,0,"quotient",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+13,0,"remainder",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBus(c+18,0,"BUSY",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+19,0,"OUT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+14,0,"S_nxt",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    ...
    tracep->declBus(c+15,0,"a_nxt",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->declBus(c+16,0,"b_nxt",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+4,0,"q",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+5,0,"q_nxt",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vdivmod___024root__trace_full_0_sub_0(Vdivmod___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode);
    // Body
    bufp->fullCData(oldp+1,(vlSelfRef.divmod__DOT__S),2);
    bufp->fullCData(oldp+2,(vlSelfRef.divmod__DOT__a),8);
    bufp->fullCData(oldp+3,(vlSelfRef.divmod__DOT__b),8);
    bufp->fullCData(oldp+4,(vlSelfRef.divmod__DOT__q),8);
    bufp->fullCData(oldp+5,(vlSelfRef.divmod__DOT__q_nxt),8);
    bufp->fullBit(oldp+6,(vlSelfRef.clk));
    bufp->fullBit(oldp+7,(vlSelfRef.rst_n));
    bufp->fullBit(oldp+8,(vlSelfRef.valid));
    bufp->fullCData(oldp+9,(vlSelfRef.dividend),8);
    bufp->fullCData(oldp+10,(vlSelfRef.divisor),8);
    bufp->fullBit(oldp+11,(vlSelfRef.ready));
    bufp->fullCData(oldp+12,(vlSelfRef.quotient),8);
    bufp->fullCData(oldp+13,(vlSelfRef.remainder),8);
    bufp->fullCData(oldp+14,(vlSelfRef.divmod__DOT__S_nxt),2);
    bufp->fullCData(oldp+15,(vlSelfRef.divmod__DOT__a_nxt),8);
    bufp->fullCData(oldp+16,(vlSelfRef.divmod__DOT__b_nxt),8);
}
