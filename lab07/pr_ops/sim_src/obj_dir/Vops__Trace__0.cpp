...
void Vops___024root__trace_chg_0_sub_0(Vops___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelfRef.ops__DOT__a),8);
    bufp->chgCData(oldp+5,(vlSelfRef.ops__DOT__b),8);
    bufp->chgCData(oldp+6,(vlSelfRef.ops__DOT__op),2);
    bufp->chgCData(oldp+7,(vlSelfRef.ops__DOT__o),8);
}
