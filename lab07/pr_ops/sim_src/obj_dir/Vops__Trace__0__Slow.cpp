...
VL_ATTR_COLD void Vops___024root__trace_full_0_sub_0(Vops___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelfRef.ops__DOT__a),8);
    bufp->fullCData(oldp+6,(vlSelfRef.ops__DOT__b),8);
    bufp->fullCData(oldp+7,(vlSelfRef.ops__DOT__op),2);
    bufp->fullCData(oldp+8,(vlSelfRef.ops__DOT__o),8);
}
