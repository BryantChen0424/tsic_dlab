...
VL_INLINE_OPT void Vops___024root___ico_sequent__TOP__0(Vops___024root* vlSelf) {
    ...
    if ((2U & (IData)(vlSelfRef.op))) {
        ...
        vlSelfRef.o = (0xffU & ((IData)(vlSelfRef.a) 
                                - (IData)(vlSelfRef.b)));
...
#endif
            VL_FATAL_MT("ops.v", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("ops.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("ops.v", 1, "", "Active region did not converge.");
            }
