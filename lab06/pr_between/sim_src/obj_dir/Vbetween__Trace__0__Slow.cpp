...
VL_ATTR_COLD void Vbetween___024root__trace_init_sub__TOP__0(Vbetween___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+4,0,"bt",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vbetween___024root__trace_full_0_sub_0(Vbetween___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(vlSelfRef.between__DOT__a),8);
    bufp->fullBit(oldp+4,(vlSelfRef.between__DOT__bt));
}
