...
void Vconst____024root__trace_chg_0_sub_0(Vconst____024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelfRef.o_auto_expand),8);
    bufp->chgCData(oldp+5,(vlSelfRef.o_auto_cut),8);
    bufp->chgBit(oldp+6,(vlSelfRef.const___DOT__ot));
    bufp->chgBit(oldp+7,(vlSelfRef.const___DOT__of));
    bufp->chgCData(oldp+8,(vlSelfRef.const___DOT__o1),8);
    bufp->chgCData(oldp+9,(vlSelfRef.const___DOT__o2),8);
    bufp->chgCData(oldp+10,(vlSelfRef.const___DOT__o_auto_expand),8);
    bufp->chgCData(oldp+11,(vlSelfRef.const___DOT__o_auto_cut),8);
}
