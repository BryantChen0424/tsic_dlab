...
VL_ATTR_COLD void Vconst____024root__trace_init_sub__TOP__0(Vconst____024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,0,"o_auto_expand",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+6,0,"o_auto_cut",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->pushPrefix("const_", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBit(c+7,0,"ot",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+9,0,"o1",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+10,0,"o2",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+11,0,"o_auto_expand",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+12,0,"o_auto_cut",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vconst____024root__trace_full_0_sub_0(Vconst____024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelfRef.o_auto_expand),8);
    bufp->fullCData(oldp+6,(vlSelfRef.o_auto_cut),8);
    bufp->fullBit(oldp+7,(vlSelfRef.const___DOT__ot));
    bufp->fullBit(oldp+8,(vlSelfRef.const___DOT__of));
    bufp->fullCData(oldp+9,(vlSelfRef.const___DOT__o1),8);
    bufp->fullCData(oldp+10,(vlSelfRef.const___DOT__o2),8);
    bufp->fullCData(oldp+11,(vlSelfRef.const___DOT__o_auto_expand),8);
    bufp->fullCData(oldp+12,(vlSelfRef.const___DOT__o_auto_cut),8);
}
